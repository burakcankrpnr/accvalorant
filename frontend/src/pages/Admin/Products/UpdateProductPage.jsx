      ...
      try {
        ...
        if (singleProductData) {
          form.setFieldsValue({
            ...
            regions: singleProductData.regions,
          });
        }
      } catch (error) {
      ...
      <Form name="basic" layout="vertical" onFinish={onFinish} form={form}>
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Lütfen stok durumunu seçin!",
            },
          ]}
        >
          <Select placeholder="Stok durumunu seçin">
            <Select.Option value="inStock">Stokta Var</Select.Option>
            <Select.Option value="outOfStock">Stokta Yok</Select.Option>
          </Select>
        </Form.Item>
        <Form.Item
          label="Bölgeler"
          ...
          rules={[
            {
              required: true,
              message: "Lütfen en az 1 bölge seçin!",
            },
          ]}
        >
          <Select
            mode="multiple"
            placeholder="Ürünün mevcut olduğu bölgeleri seçin."
            allowClear
          >
